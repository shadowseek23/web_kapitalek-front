...
const defaultSelectProps = {
  ...
  selectorIcon: (
    <span className="group-hover:scale-105">
      <TriangleIcon position="down" width="12" />
    </span>
  ),
};
...
const defaultInputClassNames = {
  ...
  innerWrapper: "py-20",
  inputWrapper:
    "h-14 min-h-14 bg-white border-t-1 border-b-1 border-t-stroke-ultralight border-b-stroke transition-all hover:border-t-beige hover:border-b-black hover:shadow-[0_3px_10px_0_rgba(0,0,0,0.1)]",
...
const defaultSelectClassNames = {
  ...
  mainWrapper: "group",
  trigger:
    "h-14 min-h-14 bg-white border-t-1 border-b-1 border-t-stroke-ultralight border-b-stroke transition-all hover:border-t-beige hover:border-b-black hover:shadow-[0_3px_10px_0_rgba(0,0,0,0.1)] !pr-4",
  innerWrapper: "",
...
export default function ContactForm() {
  ...
  return (
    ...
    >
      <div
        className="_form-wrapper
				w-full max-w-[50rem] flex flex-col gap-6 max-w-md
			"
      >
        <div
          className="_input-flex-row
					flex gap-6 flex-wrap
					lg:gap-8
				"
        >
          <div
            className="_input-column
        ...
        >
          <SelectItem key="book" classNames={defaultSelectItemClassNames}>
            Kniha
          </SelectItem>
          <SelectItem key="thesis" classNames={defaultSelectItemClassNames}>
            Diplomová/bakalářská práce
          </SelectItem>
          <SelectItem key="other" classNames={defaultSelectItemClassNames}>
            Jiné
          </SelectItem>
        </Select>
        ...
        >
          <SelectItem
            key="by_recommendation"
            classNames={defaultSelectItemClassNames}
          >
            Dle našeho doporučení
          </SelectItem>
          <SelectItem key="nit" classNames={defaultSelectItemClassNames}>
            Vazba nití
          </SelectItem>
          <SelectItem key="japonska" classNames={defaultSelectItemClassNames}>
            Japonská vazba
          </SelectItem>
          <SelectItem key="x" classNames={defaultSelectItemClassNames}>
            Vazba x
          </SelectItem>
          <SelectItem key="y" classNames={defaultSelectItemClassNames}>
            Vazba y
          </SelectItem>
        </Select>
        ...
        <Textarea
          classNames={{
            base: " my-1",
            label:
              "!text-gray font-form-label uppercase tracking-normal -mt-0.5",
            inputWrapper:
              " bg-white border-t-1 border-b-1 border-t-stroke-ultralight border-b-stroke transition-all hover:border-t-beige hover:border-b-black hover:shadow-[0_3px_10px_0_rgba(0,0,0,0.1)]",
        ...
        >
          Souhlasím s{" "}
          <NextLink
            className="text-link underline hover:text-beige transition-colors relative z-10 pointer-events-auto"
        ...
        <div className="flex gap-4 mt-6">
          <Button
            className="bg-black hover:bg-beige text-white font-base uppercase tracking-normal py-7 px-9"
            type="submit"
          >
            Odeslat poptávku
          </Button>
