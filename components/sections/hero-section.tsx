...
export const HeroSection = () => {
  ...
  return (
    <section className="border-default-b" id="hero">
      <div
        className="container
      ...
      >
        ...
        >
          ...
          >
            ...
            <h2
              className="_title-with-typewriter
								text-[2rem]
            ...
            <h3
              className="_subheading
							...
							"
            >
              Vytváříme vyjímečné knihy pro všechny, kdo ocení kvalitu a cit pro
              detail.
            </h3>
          </div>
        </motion.div>
